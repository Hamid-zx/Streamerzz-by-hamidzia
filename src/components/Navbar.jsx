    ...
    <nav className="fixed top-4 left-0 right-0 z-50 m-2">
      <div className="text-neutral-500 bg-black/60 backdrop-blur-md max-w-7xl mx-auto px-4 py-3 flex justify-between items-center rounded-xl border border-neutral-800">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <a
            href="#"
            className="border border-neutral-700 text-white py-2 px-4 rounded-lg hover:bg-neutral-900 transition"
          >
            Get a Demo
          </a>
          <a
            href="#"
            className="border border-neutral-700 text-white py-2 px-4 rounded-lg bg-blue-600 hover:bg-blue-500 transition"
          >
            Start Free Trial
          </a>
        </div>
