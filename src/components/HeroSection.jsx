  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.h1
          variants={fadeInUp}
          className="text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-gradient-to-b from-neutral-300 to-neutral-700 bg-clip-text text-transparent"
        >
        ...
        <motion.div variants={fadeInUp} className="mt-6 space-x-4">
          ...
          <a
            href="#"
            className="inline-block bg-gray-500 hover:bg-blue-500 text-white py-3 px-6 rounded-lg font-medium"
          >
        ...
        <motion.div variants={fadeIn} className="py-10">
          ...
          >
            {BRAND_LOGOS.map((logo, index) => (
              <img key={index} src={logo.src} className="h-8" />
            ))}
          </motion.div>
        </motion.div>
